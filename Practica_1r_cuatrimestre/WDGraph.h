...
public:
	...
	void getVertexs(VertexNode** ret); // Returns an array with all the vertexs of the graph in it
	...
	void getNeightbours(int e, EdgeNode** ret); // Returns the neightbours oof the given vertex
